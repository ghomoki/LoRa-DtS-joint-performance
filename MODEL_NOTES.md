...
Paper's published code is in [Bandwidth_LoRa_Dopper_effect.m](Bandwidth_LoRa_Dopper_effect.m) and [LoRa_ToA_paper.m](LoRa_ToA_paper.m).
...
| PDR (Fig. 8, Fig. 10) matches paper's published curves | ✓ (within ~2%, all non-trivial sweeps) | manually verified via [scripts/figure8.m](scripts/figure8.m), [scripts/figure10.m](scripts/figure10.m), plus `*_diag.m` for failure-type decomposition |
